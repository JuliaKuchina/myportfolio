...
export const TECHNOLOGIES: Technology[] = [
  { text: "JavaScript", size: 2, group: 1 },
  { text: "Typescript", size: 8, group: 1 },
  { text: "PHP", size: 1, group: 1 },
  { text: "SQL", size: 1, group: 1 },
  { text: "React", size: 6, group: 2 },
  { text: "Redux", size: 1, group: 2 },
  { text: "React hooks", size: 5, group: 2 },
  { text: "Jest", size: 3, group: 2 },
  { text: "Apollo", size: 1, group: 2 },
  { text: "GraphQL", size: 1, group: 2 },
  { text: "three.js", size: 3, group: 6 },
  { text: "babylon.js", size: 3, group: 6 },
  { text: "Leaflet.js", size: 3, group: 6 },
  { text: "Turf.js", size: 1, group: 6 },
  { text: "D3", size: 1, group: 6 },
  { text: "JQuery", size: 1, group: 2 },
  { text: "Styled components", size: 4, group: 2 },
  { text: "Material UI", size: 5, group: 2 },
  { text: "Bootstrap", size: 1, group: 2 },
  { text: "SVG", size: 2, group: 2 },
  { text: "PostCSS", size: 2, group: 2 },
  { text: "SASS", size: 2, group: 2 },
  { text: "CSS3", size: 4, group: 2 },
  { text: "HTML5", size: 2, group: 2 },
  { text: "GraphQL", size: 2, group: 3 },
  { text: "REST", size: 1, group: 3 },
  { text: "MySQL", size: 1, group: 4 },
  { text: "Oracle DB", size: 1, group: 4 },
  { text: "Firebase", size: 1, group: 4 },
  { text: "Webpack", size: 1, group: 5 },
  { text: "Gulp", size: 1, group: 5 },
  { text: "Git", size: 3, group: 5 },
  { text: "SVN", size: 1, group: 5 },
  { text: "Jira", size: 1, group: 5 },
  { text: "VS", size: 1, group: 5 },
  { text: "cPanel", size: 1, group: 5 },
  { text: "Photoshop", size: 1, group: 5 },
  { text: "Figma", size: 1, group: 5 },
  { text: "Agile", size: 3, group: 5 },
];
